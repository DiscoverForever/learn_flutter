class Api {
  static final String baseUrl = 'https://www.easy-mock.com/mock/5d305b107d6f934a01998c0b/';
  static final String action = Uri.encodeComponent('client.action');
  static final String appCenterInfo = Uri.encodeComponent('client.action?functionId=newAppCenterInfo');
  ...
  static final String recommendItemList = Uri.encodeComponent('client.action?functionId=uniformRecommend');
}